...
author: "Ullrika Sahlin, Dmytro Perepolkin"
...
```
## Model description
We want to build a model that predict **abundance of skylark** as a function of **agricultural area** and **landscape complexity**. The effect of agricultural land and landscape complexity on skylark is treated as a fixed effect. Abundance is a count variable so therefore we will do a Poisson regression. Data are collected in different sites (**landscapes**) and by different birdwatchers (**observer**). Unexplained variation due to landscape and observer are treated as random effects. 
